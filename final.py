...
def generate_n_questions(n):
    """Generate n random questions from the available dataset."""
    
    # Sample dataset of questions for various topics
    questions_dataset = {
        "Algorithm Analysis": [
        ...
        "Linear Data Structures": [
            ...
            "Explain the concept of circular queues."
        ],
        ...
        "Trees": [
            ...
            "Explain the different types of tree traversal."
        ],
        "Graphs": [
    ...
    # Flatten the dataset into a list of all available questions
    all_questions = []
    for topic in questions_dataset:
        all_questions.extend(questions_dataset[topic])

    # Randomly sample n questions from the available questions
    random_questions = random.sample(all_questions, n)

    # Print the n random questions
    print(f"\n{n} Randomly Generated Questions:")
...
def build_syllabus_tree():
    ...
    mst.add_resource("Prim's Algorithm", "https://youtu.be/4ZlRH0eK-qQ?si=gWwlK37fvmCkTlKa")
    mst.add_resource("Kruskal's Algorithm", "https://youtu.be/4ZlRH0eK-qQ?si=gWwlK37fvmCkTlKa")
    ...
    avl_tree.add_resource("AVL Trees Overview", "https://youtu.be/Q_eia3jC9Ts?si=9CGw3q_NPPMcOW16")
    avl_tree.add_questions("AVL Trees: Balanced Binary Search Tree", [
        "Sum of Nodes at a Given Level",
